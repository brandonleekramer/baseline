...
combined_data <- combined_data %>% 
  mutate(Time = dplyr::recode(Segment, "Baseline" = 1, "Stressor" = 2, "Recovery 1" = 3, "Recovery 2" = 4))
combined_data
...
combined_data %>% 
  mutate(HeartID = factor(combined_data$HeartID),
         ...
         Time = dplyr::recode(Segment, "Baseline" = 1, "Stressor" = 2, "Recovery 1" = 3, "Recovery 2" = 4)) %>% 
  group_by(Time) %>% 
